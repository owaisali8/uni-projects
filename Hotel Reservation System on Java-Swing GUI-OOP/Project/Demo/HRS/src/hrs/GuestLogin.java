...
public class GuestLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome to HRS");
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
      ...
      if(a.checkID(username.getText(), pass.getText())){
          userInt = a.getUserIDInt(username.getText(), pass.getText());
          new GuestManagement().show();
          this.dispose();
      }
      else {
        JFrame f =new JFrame();   
   JOptionPane.showMessageDialog(f,"Incorrect Username or Password","Alert",JOptionPane.WARNING_MESSAGE);     
    ...
    private void NewAccountActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NewAccountActionPerformed
        // TODO add your handling code here:
        this.dispose();
        new GuestCreateNewAccount().show();
